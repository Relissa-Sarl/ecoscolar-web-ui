...
<template>
    <div class="lg:col-span-1">
        ...
        <div class="pt-3 border-t border-slate-100 dark:border-slate-855">
            ...
            <p class="text-[10px] text-slate-400 dark:text-slate-500 text-right">{{ $t('cart.tva') }}</p>
        </div>
        ...
        <div class="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-2.5">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-emerald-600 dark:text-emerald-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex items-start gap-2 text-[11px] text-slate-500 dark:text-slate-400">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-blue-600 dark:text-blue-500 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
