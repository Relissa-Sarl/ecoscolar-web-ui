...
const openAdvertLink = computed(() => localePath(`/annonce/${props.item.advertId}`))
</script>
  ...
  <article class="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-950">
    ...
    <div class="flex flex-wrap gap-3">
      ...
      <button
        ...
        :disabled="removing"
        @click="emit('toggleFavorite', item.advertId)"
      >
